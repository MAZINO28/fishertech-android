...
public class AdminSavedSpotAdapter extends RecyclerView.Adapter<AdminSavedSpotAdapter.SpotViewHolder> {
    ...
    public AdminSavedSpotAdapter(List<SavedSpot> spotList, OnDeleteClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull SpotViewHolder holder, int position) {
        ...
        // Proteksyon para laging may "Buoy X" o "Custom Spot" na tag na lalabas
